        ...
        <div key={order.id} className="card">
          <div className="flex items-start justify-between gap-4 flex-wrap">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-900 font-semibold truncate">{order.productTitle}</p>
            ...
            <div className="flex gap-2 flex-wrap shrink-0">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-surface border border-surface-border text-sm text-gray-600 hover:text-gray-900 hover:border-gray-400 transition-colors"
              >
                <Download size={14} />
                다운로드
              </button>
